...
apt update
echo "deb http://archive.canonical.com/ubuntu bionic partner" >> /etc/apt/sources.list.d/rabbitmq_rabbitmq-server.list
echo "deb-src http://archive.canonical.com/ubuntu bionic partner" >> /etc/apt/sources.list.d/rabbitmq_rabbitmq-server.list
